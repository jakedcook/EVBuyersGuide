...
stateData2022 = stateData2022 %>%
  # originally i did 1.1e7 and realized on 4/16 that this was the incorrect conversion
  # updated to 1.1e12
  mutate(gCo2 = X2022 * 1e12) %>%
  mutate(gCo2pkWh = 0.0)
...
efficiencyRegionPlot(westEfficiencyData2022, "West")
...
write_csv(finalElectricityData2022, "completeStateData2022.csv")

# now I will add the north, south, midwest and west regionally data into the csvs for use later 
write.csv(northEfficiencyData2022, "northRegionData.csv")
write.csv(southEfficiencyData2022, "southRegionData.csv")
write.csv(midWestEfficiencyData2022, "midWestRegionData.csv")
write_csv(westEfficiencyData2022, "westRegionData.csv")
```
